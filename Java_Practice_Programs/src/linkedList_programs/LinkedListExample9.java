...
public class LinkedListExample9 {
	...
	public static void main(String[] args) {
		...
		try (Scanner scanner = new Scanner(System.in)) {
			...
			// Task: Insert an element at the specified position
			try {
				System.out.println("Specified position: ");
				int specifiedPosition = scanner.nextInt();
				System.out.println("Element to be inserted at " + specifiedPosition + " position: ");
				int element = scanner.nextInt();
				linkedList.add(specifiedPosition, element);
			} catch (Exception e) {
				e.printStackTrace();
			}
